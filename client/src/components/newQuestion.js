...
export default class ClassNewQuestion extends React.Component {
        ...
        console.log("textInNewQuestion Function: " + this.props.model.questions[0].length);
            return (
                <div>
                    ...
                    <textarea rows="4" cols="130" id = "keywords" value = {this.props.tags} onChange = {this.handleFilterTagsChange}></textarea>
                    <br></br>
                    <button className = "postButton" onClick = {this.props.render}> Post Question </button>
                </div>
            );
    }
}