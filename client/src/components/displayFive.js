...
export default class DisplayFive extends React.Component{
    getQuestions(){
        if(this.props.model){
    ...
    render(){
        ...
        if(this.props.model){
            ...
            if(this.props.model.questions[0].length < 5){
                ...
                console.log("ii: " + i);
                if(i !== 0){
                    let remaining = (this.props.model.questions[0].length) % 5;
                ...
                <tbody>
                    <tr className = "questionRow">
                        ...
                        <td id = "reactQuestionDisplay02" className = "middleQuestion"> All Questions </td>
                         <button id = "forButtonReact" className = "notMiddleQuestion" onClick = {this.props.renderPage}> Ask a Question </button>  
                        {userName}
                    </tr>   
                    {questionsHere}
                    {moreThanFive}
