...
export default class CommentsAnswers extends React.Component {
    getNumOfComments(){
        console.log("ok1");
    ...
    render(){
        ...
        let next = <></>;
        let prevouis = <></>;
        console.log("this.props.model.answerDetails[this.props.index].comment.length: " + this.props.model.answerDetails[this.props.index].comment.length)
            ...
            <table id = "questions"> 
                <tbody>
                    <tr className = "questionRow">
                        ...
                        <td id = "reactQuestionDisplay02" className = "middleQuestion"> All Comments For Answer  </td>
                         {askAQuestionOrNot}
                         {secondOne}
                        {userName}
                    </tr>   
